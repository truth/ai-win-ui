...
function Resolve-LayoutPath {
    ...
    $layoutAliases = @{
        ...
        "popup-theme" = "layouts/popup_theme_demo.xml"
        "popup_theme" = "layouts/popup_theme_demo.xml"
        "popup_theme_demo" = "layouts/popup_theme_demo.xml"
        "virtual-list" = "layouts/virtual_list_demo.xml"
        "virtual_list" = "layouts/virtual_list_demo.xml"
        "virtual_list_demo" = "layouts/virtual_list_demo.xml"
        "text-ellipsis" = "layouts/text_ellipsis_cases.xml"
        "text_ellipsis" = "layouts/text_ellipsis_cases.xml"
        "text_ellipsis_cases" = "layouts/text_ellipsis_cases.xml"
        "gradient-shadow" = "layouts/gradient_shadow_demo.xml"
        "gradient_shadow" = "layouts/gradient_shadow_demo.xml"
        "gradient_shadow_demo" = "layouts/gradient_shadow_demo.xml"
        "svg-tint" = "layouts/svg_tint_demo.xml"
        "svg_tint" = "layouts/svg_tint_demo.xml"
        "svg_tint_demo" = "layouts/svg_tint_demo.xml"
        "test-svg" = "layouts/test_svg.json"
        "test_svg" = "layouts/test_svg.json"
